...
CException::CException(uint32_t line, const char* file, std::string type,
...
uint32_t CException::GetLine() const noexcept { return line; }

const char* CException::GetFile() const noexcept { return file; }

std::string CException::GetType() const noexcept { return type; }
